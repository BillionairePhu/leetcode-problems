...
> **Problem:** [Binary Gap](https://leetcode.com/problems/binary-gap)<br />
> **Difficulty:** Easy<br/>
...
Iterate through the bit in the binary representation of the number (either left to right or right to left), and keep track of the index of the last `1` (on bit). We update the `result` if the current bit is further away from the last index than the current `result` value.
