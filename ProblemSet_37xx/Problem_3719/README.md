...
> **Problem:** [Longest Balanced Subarray I](https://leetcode.com/problems/longest-balanced-subarray-i)<br />
...
The constraint in this problem is quite low so we can brute-force our answer here.

Try every beginning and ending points to form a subarray. We can do this with 2 nested loops while keeping track of the distinct numbers existed in the array and the count of odd/even numbers.
