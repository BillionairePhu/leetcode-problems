...
> **Problem:** [Maximum Level Sum of a Binary Tree](https://leetcode.com/problems/maximum-level-sum-of-a-binary-tree)<br />
...
Just a simple depth-first search with and operation on a dictionary for each traversal.
