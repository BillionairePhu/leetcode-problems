...
> **Problem:** [Sum of Root To Leaf Binary Numbers](https://leetcode.com/problems/sum-of-root-to-leaf-binary-numbers)<br />
> **Difficulty:** Easy<br/>
...
Just do a simple depth-first search and add values to the result when reaching leaves
