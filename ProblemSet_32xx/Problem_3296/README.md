...
> **Problem:** [Minimum Number of Seconds to Make Mountain Height Zero](https://leetcode.com/problems/minimum-number-of-seconds-to-make-mountain-height-zero)<br />
...
Let `n` be mountain height and `m` be number of employees.
