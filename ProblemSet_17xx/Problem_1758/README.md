...
> **Problem:** [Minimum Changes To Make Alternating Binary String](https://leetcode.com/problems/minimum-changes-to-make-alternating-binary-string)<br />
> **Difficulty:** Easy<br/>
> **Tags:** `String`
...
There are only two scenarios: alternating binary string start with 0 or alternating binary string start with 1.

Count the valid digit in each scenario and evaluate to get the result.
