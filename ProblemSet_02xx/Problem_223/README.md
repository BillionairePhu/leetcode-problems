...
> **Problem:** [Rectangle Area](https://leetcode.com/problems/rectangle-area)<br />
...
Find the x1, y1 and x2, y2 of the overlapping square and compute its area.

The final result is the combination of 2 squares minus the overlapping area.
