...
> **Problem:** [Construct the Minimum Bitwise Array II](https://leetcode.com/problems/construct-the-minimum-bitwise-array-ii)<br />
...
Suppose ans end with exactly <code>k</code> digits "1" in its binary respresentation. Then <code>ans = a0111...1</code> and <code>p = ans | (ans + 1) = a1111...1</code>.

Hence if <code>p</code> ends with at least <code>k+1</code> digits "1". In other words, if <code>p</code> ends with exactly <code>t</code> digits "1", then <code>k&le;t-1</code>.

Rewriting <code>ans = a1111...1-1000...0=p-1000...0</code>. Hence to minimize ans is to maximize k. Therefore <code>k = t - 1</code>.

---

### 🧪 Complexity
With <code>n</code> being the number of digits that <code>num</code> has.
- **Time:** O(n)
- **Space:** O(1)