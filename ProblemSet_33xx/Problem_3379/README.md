...
> **Problem:** [Transformed Array](https://leetcode.com/problems/transformed-array)<br />
> **Difficulty:** Easy<br/>
...
Just do as the description of the problem requested. We will generate an array (result array) of the same size and for each index `i` of the new array, we will get the steps (can be negative) by getting `nums[i]` and move that steps by adding with modulo the steps to the index `i`, the value of the corresponding element after moved is the value to be added to the result array.
