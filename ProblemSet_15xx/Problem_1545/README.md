...
> **Problem:** [Find Kth Bit in Nth Binary String](https://leetcode.com/problems/find-kth-bit-in-nth-binary-string)<br />
...
Since the string S_n is formed by recursion, we can use recursive approach to solve this problem.
