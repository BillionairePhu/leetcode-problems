...
> **Problem:** [Minimum Penalty for a Shop](https://leetcode.com/problems/minimum-penalty-for-a-shop)<br />
...
We start with closing the store at 0th hour and calculate the penalty for that time.

Then we iterate through the hours and calculate the penalty at that hour based on the penalty at the previous hour.

If there is no customer at the i-th hour: `P(i) = P(i-1) + 1`
Else: `P(i) = P(i-1) - 1`
