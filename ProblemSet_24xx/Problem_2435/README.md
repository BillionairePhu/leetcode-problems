...
> **Problem:** [Paths in Matrix Whose Sum Is Divisible by K](https://leetcode.com/problems/paths-in-matrix-whose-sum-is-divisible-by-k)<br />
> **Difficulty:** Hard<br/>
...
> Typical DP programming problem. We only need to infer the relationships between the cells.
