...
> **Problem:** [N-Repeated Element in Size 2N Array](https://leetcode.com/problems/n-repeated-element-in-size-2n-array)<br />
> **Difficulty:** Easy<br/>
...
We can implement using the naive method of counting or using Boyer-Moore voting algorithm.
...
- **Time:** O(n)
- **Space:** O(n) for naive or O(1) for Boyer-Moore voting algorithm