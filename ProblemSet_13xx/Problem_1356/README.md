...
> **Problem:** [Sort Integers by The Number of 1 Bits](https://leetcode.com/problems/sort-integers-by-the-number-of-1-bits)<br />
> **Difficulty:** Easy<br/>
...
Just use sort with the key function being the function to get the number of `1` bit from a number binary representation.
