...
> **Problem:** [Find Smallest Letter Greater Than Target](https://leetcode.com/problems/find-smallest-letter-greater-than-target)<br />
> **Difficulty:** Easy<br/>
...
This is a typical binary search (the keyword here is "the array has already been sorted"). =DD quite straightforward, if you don't understand, research about binary search
